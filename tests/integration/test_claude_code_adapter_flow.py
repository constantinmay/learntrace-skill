"""End-to-end privacy test for the Claude Code adapter and result writer."""
...
from learntrace.adapters import adapt_claude_code_export, write_trace_result
from learntrace.models import ContractValidator

FIXTURE_PATH = Path(__file__).parents[1] / "fixtures" / "claude-code" / "authorized-session.jsonl"
